...
export function BrokerSettings({ brokers }: BrokerSettingsProps) {
  return (
      ...
      <Card className="border-none shadow-sm">
        <CardHeader className="bg-primary/5 border-b">
          ...
          <CardDescription className="text-xs text-muted-foreground !mt-2">
            Esta é uma lista de todos os corretores únicos encontrados automaticamente nas suas planilhas de Cadastro, Leads e Vendas.
          </CardDescription>
        </CardHeader>
                ...
                <TableBody>
                    ...
                    <TableRow>
                        ...
                        <div className="flex flex-col items-center gap-2">
                            ...
                            <p className="text-xs">Nenhum corretor encontrado nas planilhas.</p>
                        </div>
                        </TableCell>
                    </TableRow>
                    )}
